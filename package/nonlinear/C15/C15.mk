...
C15_CONF_OPTS += -DTARGET_PLATFORM=bbb -DBUILD_BBB_SCRIPTS=On -DBUILD_BRIDGE=On -DBUILD_TEXT2SOLED=On -DBUILD_PLAYCONTROLLER_TOOLS=On -DCMAKE_BUILD_TYPE=Release
