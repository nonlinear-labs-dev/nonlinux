...
C15_DEPENDENCIES = util-linux glibmm libsoup boost systemd freetype alsa-lib
C15_SOURCE_DIR = $(C15_DIR)
C15_INSTALL_TARGET = YES
C15_CONF_OPTS += -DTARGET_PLATFORM=bbb -DBUILD_BBB_SCRIPTS=On -DBUILD_BRIDGE=On -DBUILD_TEXT2SOLED=On -DBUILD_PLAYCONTROLLER_TOOLS=On -DBUILD_SUPERVISOR_TOOLS=On -DCMAKE_BUILD_TYPE=Release
