...
C15_CONF_OPTS += -DBUILD_REALTIME_SYSTEM=Off -DBUILD_LPC=Off -DBUILD_AUDIOENGINE=Off -DBUILD_PLAYGROUND=Off -DBUILD_ONLINEHELP=Off -DBUILD_BBBB=On -DBUILD_TEXT2SOLED=On -DBUILD_TESTING=Off -DCMAKE_BUILD_TYPE=Release
